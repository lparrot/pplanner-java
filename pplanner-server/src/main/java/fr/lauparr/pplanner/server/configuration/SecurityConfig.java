...
import fr.lauparr.pplanner.server.security.SrvTokenAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private SrvTokenAuthenticationFilter srvTokenAuthenticationFilter;
	...
	protected void configure(final HttpSecurity http) throws Exception {
		...
		// Ajout du filter JWT
		http.addFilterBefore(this.srvTokenAuthenticationFilter, UsernamePasswordAuthenticationFilter.class);
